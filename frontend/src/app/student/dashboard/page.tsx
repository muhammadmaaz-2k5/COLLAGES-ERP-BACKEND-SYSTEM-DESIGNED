        ...
        <div className="container mx-auto flex h-16 items-center justify-between px-4 sm:px-8">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-tr from-indigo-600 to-indigo-500 text-white shadow-sm">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-500">Module 1 Live Session</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="space-y-2 max-w-2xl">
              <div className="inline-flex items-center gap-2 rounded-full bg-indigo-500/20 px-3 py-1 text-xs text-indigo-200 border border-indigo-500/30 backdrop-blur-sm">
                ...
                <span>Single Source of Academic GPA Active</span>
              </div>
